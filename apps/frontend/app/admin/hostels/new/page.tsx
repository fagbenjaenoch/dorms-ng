    ...
    <main className="grow md:ml-64 min-h-screen">
      ...
      <div className="p-4 sm:p-8 max-w-6xl mx-auto pb-32">
        <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tighter text-on-surface mb-2">
              Create Hostel <span className="italic text-primary">Listing</span>
            </h1>
        ...
        <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
          {/* General Info */}
          <section className="bg-surface-container-lowest p-6 sm:p-8 rounded-[2rem] shadow-sm border-t-4 border-primary">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        {...field}
                        className="w-full bg-surface text-on-surface rounded-xl border-none p-4 text-lg font-bold placeholder:text-outline/40 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-0 h-auto"
                        placeholder="e.g., Royal Palms International"
                      />
                    )}
                  />
                </div>
                    ...
                    <div className="relative">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Input
                            {...field}
                            className="w-full bg-surface text-on-surface rounded-xl border-none p-4 pl-8 h-auto font-medium focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-0"
              ...
              <div className="bg-primary/5 rounded-[2rem] p-6 flex flex-col justify-center border border-primary/10 relative overflow-hidden group">
                ...
                <Sparkles
                  ...
                  fill="currentColor"
                />
                <p className="text-sm font-medium text-on-surface-variant italic leading-relaxed relative z-10">
                  "Tip: Using highly descriptive names helps students locate your
                  listing faster in the search grid."
                </p>
              </div>
            </div>
          </section>
                ...
                <div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Textarea
                        {...field}
                        className="w-full bg-surface-container-lowest text-on-surface rounded-xl border-none p-4 font-medium focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-0 resize-none"
                  ...
                  <div>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Input
                          {...field}
                          className="w-full bg-surface-container-lowest rounded-xl border-none p-3 text-sm focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-0"
                          placeholder="6.5244"
                        />
                      )}
                    />
