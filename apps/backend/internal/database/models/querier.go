...
type Querier interface {
	CheckHostelExists(ctx context.Context, name string) (bool, error)
	...
	GetHostelsByInstitution(ctx context.Context, arg GetHostelsByInstitutionParams) ([]Hostel, error)
	GetHostelsByNeighborhood(ctx context.Context, arg GetHostelsByNeighborhoodParams) ([]Hostel, error)
