...
type Querier interface {
	...
	CreateUserIdentity(ctx context.Context, arg CreateUserIdentityParams) (UserCredential, error)
	...
	GetUserCredentialByUserId(ctx context.Context, userID string) (UserCredential, error)
